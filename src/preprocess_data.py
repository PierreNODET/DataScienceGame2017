...
def preprocess_data(df):
    ...
    df.loc[(df["release_date"].dt.year>=1980) & (df["release_date"].dt.year<2010),"release_period"]="80s - 2010s"
...
train.to_csv("data/inter/train.csv",index=False)
test.to_csv("data/inter/test.csv",index=False)
